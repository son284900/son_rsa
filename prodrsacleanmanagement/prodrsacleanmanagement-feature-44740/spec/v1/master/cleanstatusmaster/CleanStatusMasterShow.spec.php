...
/**
 * Unit Test
 * CleanStatusMasterController Show API
 *
 * @author y_kishimoto
 */
describe('[ CleanStatusMasterController Show API ]', function () {
    ...
    context('[ Exception Test ]', function () {
        ...
        describe('Function Exception Test', function () {
            beforeEach(function () {
                ...
                $request = new CleanStatusMasterShowRequest();
                $request->merge(array(
                    'id' => 1,
                ));
            ...
            it('[Test No. ] Check If The Response Of The Function " public function show(): void " Is Correct', function () {
                try {
                    ...
                    $this->diContainer[CleanStatusMasterContainer::KEY_CLEAN_STATUS_MASTER]->show();
                } catch (\Exception $e) {
                }
